...
import { ExtractFromEmailResult, extractFromEmailSIPBLLMs } from "../llm/emailToEventsSIPBLLMs.js";
import { Event } from "../llm/emailToEvents.js";
/**
...
export async function debugEmailToEvents(messageSource: Source): Promise<Event[]> {
  ...
  const result: ExtractFromEmailResult = await extractFromEmailSIPBLLMs(
